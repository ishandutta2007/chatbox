...
1. 统一模型列表，自动获取各服务商最新模型信息
2. 重新设计思考过程和联网搜索的展示方式，AI 推理过程更直观
3. 全新 Copilot 系统，提供预配置的 AI 助手，方便快速开始常见任务
4. 代码高亮切换为 Shiki，支持更多语言和主题
5. 支持设置会话背景图片，打造个性化聊天界面
6. 新增通义千问、MiniMax、Moonshot 的 OAuth 登录支持
7. 字体大小设置现在仅影响聊天消息，不再影响整个界面
8. 多项移动端 UI 优化，包括底部操作栏和模型选择器
